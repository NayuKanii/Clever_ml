...
blue_bonuses = ["five_orange", "cross_yellow", "fox", "cross_green",
                "six_purple"]


class Blue:

    def __init__(self, grid=blue_grid, available_points=blue_available_points,
                 actions=blue_actions, bonuses=blue_bonuses):
